...
internal void
draw_rect(float x, float y, float half_size_x, float half_size_y, u32 color) { // Делаем размер досок зависимыми от размера экрана
...
internal void
draw_text(const char *text, float x, float y, float size, u32 color) { // Прорисовка надписи
